...
export const constellations: Constellation[] = [
  ...
  // ============================================================
  // EASY (15)
  // Well-known, with bright distinctive stars
  // ============================================================
  ...
  makeCon('scorpius', 'Scorpius', 'Sco', 'easy', [
    ...
    { from: 0, to: 3 }, { from: 3, to: 5 }, { from: 5, to: 4 },
    { from: 4, to: 7 },
  ]),
  ...
  makeCon('ursa_minor', 'Ursa Minor', 'UMi', 'easy', [
    ...
    { from: 0, to: 4 }, { from: 4, to: 5 }, { from: 5, to: 3 },
    { from: 3, to: 1 }, { from: 1, to: 2 },
  ]),

  makeCon('andromeda', 'Andromeda', 'And', 'easy', [
  ...
  // ============================================================
  // MEDIUM (30)
  // Moderately well-known constellations
  // ============================================================
  ...
  makeCon('pegasus', 'Pegasus', 'Peg', 'medium', [
    ...
    { ra: 21.74, dec:  9.88,  mag: 2.49,  name: 'Markab' },      // 2
    { ra: 22.83, dec: 24.60,  mag: 2.83,  name: 'Algenib' },     // 3
    { ra:  0.14, dec: 29.09,  mag: 2.06,  name: 'Alpheratz' },   // 4
    { ra: 23.08, dec: 28.08,  mag: 2.83,  name: 'Matar' },       // 5
  ], [
    { from: 0, to: 5 }, { from: 5, to: 1 }, { from: 1, to: 2 },
    { from: 2, to: 3 }, { from: 3, to: 4 }, { from: 4, to: 1 },
  ]),
  ...
  makeCon('piscis_austrinus', 'Piscis Austrinus', 'PsA', 'medium', [
  ...
  makeCon('puppis', 'Puppis', 'Pup', 'medium', [
  ...
  makeCon('hydra', 'Hydra', 'Hya', 'medium', [
  ...
  makeCon('eridanus', 'Eridanus', 'Eri', 'medium', [
    { ra:  1.63, dec: -57.24, mag: 0.46,  name: 'Achernar' },    // 0
    { ra:  2.97, dec: -40.30, mag: 2.80,  name: 'Cursa' },       // 1
    { ra:  2.44, dec: -47.70, mag: 3.06,  name: 'Acamar' },      // 2
  ...
  makeCon('canis_minor', 'Canis Minor', 'CMi', 'medium', [
  ...
  makeCon('cetus', 'Cetus', 'Cet', 'medium', [
  ...
  makeCon('carina', 'Carina', 'Car', 'medium', [
  ...
  // ============================================================
  // HARD (43)
  // Dim, small, or obscure constellations
  // ============================================================

  makeCon('draco', 'Draco', 'Dra', 'hard', [
  ...
  makeCon('cepheus', 'Cepheus', 'Cep', 'hard', [
  ...
  makeCon('triangulum', 'Triangulum', 'Tri', 'hard', [
  ...
  makeCon('cancer', 'Cancer', 'Cnc', 'hard', [
  ...
  makeCon('delphinus', 'Delphinus', 'Del', 'hard', [
  ...
  makeCon('sagitta', 'Sagitta', 'Sge', 'hard', [
  ...
  makeCon('crater', 'Crater', 'Crt', 'hard', [
  ...
  makeCon('sextans', 'Sextans', 'Sex', 'hard', [
    ...
    { ra:  9.87, dec:  -8.10, mag: 5.07,  name: 'Beta Sex' },    // 1
    { ra: 10.50, dec:  -2.73, mag: 5.65,  name: 'Gamma Sex' },   // 2
  ], [
...
// ============================================================
// Post-process: replace the last erroneous entry with Sextans
// (already done inline above — the final entry IS Sextans)
// The 88 IAU constellations are now all covered.
// ============================================================

// Background stars for atmosphere (bright stars not in constellations above)
export const backgroundStars: Star[] = [
  { ra:  6.40, dec: -52.70, mag: -0.72 }, // Canopus (also in Carina)
  ...
  { ra:  3.79, dec:  24.11, mag:  3.70 }, // Pleiades area
